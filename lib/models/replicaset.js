...
var isNotReplicaset = require('../mongodb-error').isNotReplicaset;
var isNotAuthorized = require('../mongodb-error').isNotAuthorized;
var isRouter = require('../mongodb-error').isRouter;
...
/**
 * Discovers the members inside of a replicaset and creates a list of them.
