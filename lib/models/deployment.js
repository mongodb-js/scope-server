...
/**
 * @todo(imlucas) explain what/why squashing exists.
 *
 * @param  {[type]}   deployment [description]
...
/**
 * Creates a new deployment from a Connection model. It connects to the instance
 * specified and then walks through the instance to discover the different replicasets,
 * shards, and servers.
...
/**
 * Get a deployment from the store.
 * @param  {String} id
 * @param  {Function} fn
 */
