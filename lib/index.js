...
app.post('/api/v1/token', ejson, urldecode, token.post);
...
app.get('/api/v1/:instance_id/collections/:ns/count',
  token_required, collection_required, urldecode, collection.count);

app.get('/api/v1/:instance_id/collections/:ns/find',
  token_required, collection_required, urldecode, collection.find);

app.get('/api/v1/:instance_id/collections/:ns/sample',
  token_required, collection_required, urldecode, sample_options, collection.sample);

app.get('/api/v1/:instance_id/collections/:ns/aggregate',
  token_required, collection_required, urldecode, collection.aggregate);
...
module.exports.start = function(opts) {
  ...
  app.server.listen(app.config.get('port'), app.config.get('hostname'), function() {
    console.log('   ');
    console.log('   scout-server ready ', app.config.get('listen'));
    console.log('   ');
  });
};
